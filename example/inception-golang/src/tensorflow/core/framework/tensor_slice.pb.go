...
func (*TensorSliceProto) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func (*TensorSliceProto_Extent) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0, 0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/tensor_slice.proto", fileDescriptor16) }
