...
func (*VersionDef) Descriptor() ([]byte, []int) { return fileDescriptor19, []int{0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/versions.proto", fileDescriptor19) }
